...
import com.ccq.app.weidget.ChatView;
        ...
        ImageLoader imageLoader = new ImageLoader() {
            ...
            public void loadImage(final ImageView imageView, String string) {
                ...
                Glide.with(getApplicationContext())
                        .load(string)
                        .fitCenter().placeholder(R.drawable.aurora_picture_not_found).into(imageView);
...
//
//                                imageView.setImageBitmap(Bitmap.createBitmap(((BitmapDrawable)resource).getBitmap(), 0, 0, imageWidth, imageHeight, matrix, true));
//
//                            }
//                        });
            }
