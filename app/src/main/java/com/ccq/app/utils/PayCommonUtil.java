...
/**
 * Created by littlemax on 2018/5/21.
 */

public class PayCommonUtil {

    //微信参数配置
    public static String API_KEY = "jiu8asfu32j4lj32432u98fdajslkfjq";
...
//            }
    ...
    public static String createSign(SortedMap<String, Object> parameters) {
        ...
        buffer.append("key=jiu8asfu32j4lj32432u98fdajslkfjq");
        String origin = buffer.toString();
        Log.d("createSign", "签名结果：" + origin);
        String sign = MD5.getMD5(origin.getBytes()).toUpperCase();
        return sign;
    }
