...
public class StatusBarUtils {
     ...
     */
    static boolean MIUISetStatusBarLightMode(Activity activity, boolean lightMode) {
...
//            e.printStackTrace();
     ...
     */
    static boolean FlymeSetStatusBarLightMode(Activity activity, boolean lightMode) {
        boolean result = false;
        try {
...
//            e.printStackTrace();
    ...
    /**
     * 状态栏亮色模式，清除MIUI、flyme或6.0以上版本状态栏白色文字、图标
     */
