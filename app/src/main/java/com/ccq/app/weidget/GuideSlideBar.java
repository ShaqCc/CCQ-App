...
public class GuideSlideBar extends View{
    ...
    public GuideSlideBar(Context context) {
        this(context, null);
    }

    public GuideSlideBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GuideSlideBar(Context context, AttributeSet attrs, int defStyle) {
