...
public class FinishRegisterActivity extends BaseActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            int i = view.getId();if(i==R.id.mine_header){if ((ContextCompat.checkSelfPermission(FinishRegisterActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) ||
...
}else if(i==R.id.iv_back){finish();

}else if(i==R.id.finish_btn){mDialog = new ProgressDialog(FinishRegisterActivity.this);
