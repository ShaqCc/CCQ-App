...
//        mSideBar.setTextView(mLetterHintTv);
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int i = v.getId();if(i==R.id.return_btn){Intent intent = new Intent();
                    setResult(JGApplication.RESULT_CODE_ALL_MEMBER, intent);
                    finish();

}else if(i==R.id.right_btn){if (mIsDeleteMode) {
    ...
    private void showDeleteMemberDialog(final List<String> list) {
        View.OnClickListener listener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int i = v.getId();if(i==R.id.jmui_cancel_btn){mDialog.dismiss();

}else if(i==R.id.jmui_commit_btn){mDialog.dismiss();
    ...
    private void addMemberToGroup() {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int i = view.getId();if(i==R.id.jmui_cancel_btn){dialog.cancel();

}else if(i==R.id.jmui_commit_btn){final String targetId = userNameEt.getText().toString().trim();
