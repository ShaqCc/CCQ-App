...
public class HistoryFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public void onClick(View view) {
        int i = view.getId();if(i==R.id.actionbar_album_btn){mSFView.setCurrentItem(0);

}else if(i==R.id.actionbar_file_btn){mSFView.setCurrentItem(1);

}else if(i==R.id.actionbar_video_btn){mSFView.setCurrentItem(2);

}else if(i==R.id.actionbar_audio_btn){mSFView.setCurrentItem(3);

}else if(i==R.id.actionbar_other_btn){mSFView.setCurrentItem(4);

}else if(i==R.id.return_btn){mContext.finish();

}else if(i==R.id.delete_file_btn){if (idMap.size() == 0) {
                    return;
                }
                if (isGroup) {
...
}else if(i==R.id.tv_choose){mSFView.setDeleteRl();
