...
public class ReceiptMessageListActivity extends FragmentActivity implements ViewPager.OnPageChangeListener,
    ...
    public void onClick(View v) {
        int i = v.getId();if(i==R.id.return_btn){finish();

}else if(i==R.id.tv_noRead){mReceipt_viewPager.setCurrentItem(0);

}else if(i==R.id.tv_alreadyRead){mReceipt_viewPager.setCurrentItem(1);
