...
public class GroupNotFriendActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();if(i==R.id.btn_add_friend){if (mUserInfo.isFriend()) {
...
}else if(i==R.id.btn_send_message){intent.setClass(GroupNotFriendActivity.this, ChatActivity.class);
                //创建会话
...
}else if(i==R.id.return_btn){finish();

}else if(i==R.id.iv_more){intent.setClass(GroupNotFriendActivity.this, NotFriendSettingActivity.class);
