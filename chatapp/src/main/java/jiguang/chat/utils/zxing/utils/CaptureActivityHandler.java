...
}else if(message.what==R.id.decode_succeeded){state = State.SUCCESS;
...
}else if(message.what==R.id.decode_error){scanManager.handleDecodeError((Exception)message.obj);
