...
public class ChatDetailController implements OnClickListener, OnItemClickListener,
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();if(i==R.id.return_btn){intent.putExtra("deleteMsg", mDeleteMsg);
            ...
            // 设置群组名称
}else if(i==R.id.group_name_ll){mContext.updateGroupNameDesc(mGroupId, 1);

}else if(i==R.id.group_desc_ll){mContext.updateGroupNameDesc(mGroupId, 2);

}else if(i==R.id.rl_groupAvatar){intent.setClass(mContext, GroupAvatarActivity.class);
            ...
            // 删除聊天记录
}else if(i==R.id.group_chat_del_ll){OnClickListener listener = new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        int i1 = view.getId();if(i1==R.id.jmui_cancel_btn){mDialog.cancel();

}else if(i1==R.id.jmui_commit_btn){Conversation conv;
                                if (mIsGroup) {
            ...
            //删除好友或群组
}else if(i==R.id.chat_detail_del_group){OnClickListener listener=new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        int i1 = view.getId();if(i1==R.id.jmui_cancel_btn){mDialog.cancel();

}else if(i1==R.id.jmui_commit_btn){deleteAndExit();
                                mDialog.cancel();
...
}else if(i==R.id.tv_moreGroup){intent.setClass(mContext, GroupGridViewActivity.class);
...
}else if(i==R.id.chat_detail_add_friend){if (mUserInfo.isFriend()) {
...
}else if(i==R.id.clear_rl){final Dialog clear = new Dialog(mContext, R.style.jmui_default_dialog_style);
                ...
                OnClickListener listen = new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        int i1 = v.getId();if(i1==R.id.btn_del){if (mIsGroup) {
...
}else if(i1==R.id.btn_cancel){clear.dismiss();
...
}else if(i==R.id.chat_file){intent = new Intent(mContext, HistoryFileActivity.class);
    ...
    public void onChanged(int id, final boolean checked) {
        if(id==R.id.no_disturb_slip_btn){final Dialog dialog = DialogCreator.createLoadingDialog(mContext, mContext.getString(R.string.processing));
                dialog.show();
...
}else if(id==R.id.block_slip_btn){mDialog = DialogCreator.createLoadingDialog(mContext, mContext.getString(R.string.processing));
                mDialog.show();
