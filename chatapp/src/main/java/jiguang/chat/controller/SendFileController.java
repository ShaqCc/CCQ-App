...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public void onClick(View view) {
        int i = view.getId();if(i==R.id.actionbar_file_btn){mSFView.setCurrentItem(0);

}else if(i==R.id.actionbar_video_btn){mSFView.setCurrentItem(1);

}else if(i==R.id.actionbar_album_btn){mSFView.setCurrentItem(2);
...
}else if(i==R.id.send_file_btn){if (mSize == 0) {
                    return;
                }
