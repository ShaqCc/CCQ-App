...
public class ContactsController implements View.OnClickListener, SideBar.OnTouchingLetterChangedListener {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();if(i==R.id.ib_goToAddFriend){intent.setClass(mContext, SearchForAddFriendActivity.class);
...
}else if(i==R.id.group_ll){intent.setClass(mContext, GroupActivity.class);
                mContext.startActivity(intent);

}else if(i==R.id.search_title){intent.setClass(mContext, SearchContactsActivity.class);
                mContext.startActivity(intent);
