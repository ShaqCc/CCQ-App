...
public class FriendInfoController implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();if(i==R.id.btn_goToChat){mContext.startChatActivity();

}else if(i==R.id.iv_friendPhoto){mContext.startBrowserAvatar();

}else if(i==R.id.jmui_commit_btn){Intent intent = new Intent(mContext, FriendSettingActivity.class);
