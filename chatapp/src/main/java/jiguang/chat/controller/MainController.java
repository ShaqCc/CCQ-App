...
public class MainController implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();if(i==R.id.actionbar_msg_btn){mMainView.setCurrentItem(0, false);

}else if(i==R.id.actionbar_contact_btn){mMainView.setCurrentItem(1, false);

}else if(i==R.id.actionbar_me_btn){mMainView.setCurrentItem(2, false);
